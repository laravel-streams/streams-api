...
class UpdateStreamTest extends ApiControllerTest
{
    ...
    public function setUp(): void
    {
        ...
        $file = base_path('streams/api_test_update_stream.json');
    ...
    public function testResponseStructure()
    {
        ...
        $instance = Streams::entries('core.streams')->find('api_test_update_stream');
    ...
    //         'name' => 'Updated!',
    //     ], [
    //         'stream' => 'api_test_update_stream_test_404',
    //     ]);
